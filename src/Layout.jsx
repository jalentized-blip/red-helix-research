...
import { ShoppingCart, Menu, X, Send, Search, ToggleLeft, ToggleRight, ChevronDown, Shield } from 'lucide-react';
        ...
        <AnimatePresence>
          {isExpanded && showResults && searchQuery && (
            <motion.div
              ...
              onMouseEnter={() => setIsExpanded(true)}
              className="absolute top-full mt-3 w-[90vw] max-w-[400px] right-0 md:-right-4 max-h-[70vh] overflow-y-auto bg-white/98 backdrop-blur-xl border border-slate-200 rounded-2xl shadow-2xl z-50 p-2"
            >
              {!hasResults ? (
    ...
    <div className="min-h-screen bg-white relative">
        ...
        {/* Fixed Header */}
          <header
              ...
              className="fixed top-0 left-0 right-0 z-[68] bg-white/95 backdrop-blur-xl border-b border-slate-100 transition-transform duration-300 shadow-sm"
                        ...
                        <>
                          ...
                          {!viewAsUser && (
                            <>
                              ...
                              <Link to={createPageUrl('AdminBannerManager')} className="text-left text-sm font-black text-black uppercase tracking-widest hover:text-white hover:bg-[#8B2635] px-4 py-3.5 transition-all rounded-lg border border-transparent hover:border-red-700 shadow-sm hover:shadow-red-200">
                                Banner Manager
                              </Link>
