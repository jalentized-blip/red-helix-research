...
const TopicItem = React.memo(({ topic, isCompleted, isActive, moduleColor, onClick }) => (
  <button
    ...
    className={`w-full text-left p-6 rounded-xl border-2 transition-all ${
      isActive
        ? `bg-gradient-to-r ${moduleColor}/10 border-white/30`
        : isCompleted
...
export default function LearningPathway({ module, onBack, onComplete }) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Completion Badge */}
      {isModuleComplete && (
        <div className="bg-gradient-to-br from-green-600/20 to-green-700/10 border-2 border-green-600/30 rounded-2xl p-8 text-center">
