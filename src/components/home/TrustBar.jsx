  ...
  return (
    <section className="bg-white border-y border-slate-100 py-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        {/* Features */}
        <div className="grid grid-cols-2 md:flex md:flex-wrap justify-center gap-4 md:gap-16 mb-8 md:mb-10">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-center gap-2 md:gap-3 text-slate-600 group cursor-default"
            >
              <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:border-[#dc2626]/30 transition-colors shadow-sm">
                <feature.icon className="w-5 h-5 text-[#8B2635]" />
              </div>
        ...
        {/* Payment & Guarantees */}
        <div className="flex flex-wrap items-center justify-center gap-5 md:gap-10 pt-8 md:pt-10 border-t border-slate-100">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-2 text-slate-600">
              <RefreshCw className="w-4 h-4 text-[#8B2635]" />
