                ...
                <motion.div key="zelle" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="bg-white border-2 border-slate-200 rounded-2xl p-6 md:p-8">
                  ...
                  <div className="max-w-md mx-auto text-center">
                    ...
                    <div className="flex flex-col items-center mb-6">
                      <div className="p-3 bg-white border-2 border-purple-100 rounded-2xl shadow-sm inline-block overflow-hidden" style={{width: 216, height: 216}}>
                        <img
                          src="https://media.base44.com/images/public/6972f2b59e2787f045b7ae0d/2d294de22_generated_image.png"
                          alt="Zelle QR Code"
                          style={{width: 192, height: 192, objectFit: 'cover', objectPosition: 'center 55%'}}
