          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] md:rounded-[40px] p-6 md:p-12 shadow-xl shadow-slate-100 h-full flex flex-col">
              ...
              <div className="mt-auto">
                <Button 
                  className="w-full bg-red-600 hover:bg-red-700 text-white py-8 md:py-10 rounded-[20px] md:rounded-[24px] text-lg md:text-2xl font-black uppercase tracking-tighter shadow-lg shadow-red-200 transition-all active:scale-[0.98] disabled:bg-slate-100 disabled:text-slate-400 disabled:shadow-none" 
