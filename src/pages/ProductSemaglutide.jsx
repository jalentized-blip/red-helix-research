      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          >
            <div className="bg-white border border-slate-200 rounded-[32px] md:rounded-[40px] p-6 md:p-12 shadow-xl shadow-slate-100 h-full flex flex-col">
              <div className="mb-6 md:mb-8">
                ...
                <h1 className="text-4xl md:text-7xl font-black text-slate-900 mb-2 uppercase tracking-tighter leading-none">
                  {product.name}
                </h1>
              ...
              <div className="mt-auto">
                <Button 
                  className="w-full bg-[#dc2626] hover:bg-[#b91c1c] text-white py-8 md:py-10 rounded-[20px] md:rounded-[24px] text-lg md:text-2xl font-black uppercase tracking-tighter shadow-lg shadow-red-200 transition-all active:scale-[0.98] disabled:bg-slate-100 disabled:text-slate-400 disabled:shadow-none" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white border border-slate-200 rounded-[32px] md:rounded-[40px] p-8 md:p-12 shadow-xl shadow-slate-100"
          >
            ...
            <div className="space-y-3 md:space-y-4">
              {[
                { label: 'Amino Acids', value: '31' },
                { label: 'Peptide Type', value: 'GLP-1 Analog' },
                { label: 'Molecular Weight', value: '~4,113 Da' },
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-slate-900 text-white rounded-[32px] md:rounded-[40px] p-8 md:p-12 shadow-xl shadow-slate-900/10"
          >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 md:mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 text-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Every SM batch includes an independent COA with HPLC purity, MS confirmation, and sterility results.</p>
              <Link to={createPageUrl('COAReports')} className="text-[10px] font-black text-[#dc2626] uppercase tracking-widest mt-3 inline-block hover:underline">View COA Reports →</Link>
            </div>
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 text-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Use our free peptide calculator to determine exact SM reconstitution volumes and concentrations.</p>
              <Link to={createPageUrl('PeptideCalculator')} className="text-[10px] font-black text-[#dc2626] uppercase tracking-widest mt-3 inline-block hover:underline">Calculate Dosage →</Link>
            </div>
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 text-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Read our comprehensive GLP-1 analog research guide with molecular data and clinical references.</p>
              <Link to={createPageUrl('BlogGuide')} className="text-[10px] font-black text-[#dc2626] uppercase tracking-widest mt-3 inline-block hover:underline">Read Research →</Link>
            </div>
          </div>
        </motion.div>
        ...
        <RelatedPeptides currentPeptide="Semaglutide" />
