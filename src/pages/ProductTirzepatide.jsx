  ...
  return (
    <div className="min-h-screen bg-white pt-24 md:pt-32 pb-12 md:pb-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 md:mb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 text-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Every TRZ batch includes an independent COA with HPLC purity, MS confirmation, and sterility results.</p>
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 text-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Use our free peptide calculator to determine exact TRZ reconstitution volumes and concentrations.</p>
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 text-center">
              ...
              <p className="text-xs text-slate-500 font-medium">Read our comprehensive dual GLP-1/GIP agonist research guide with molecular data and references.</p>
        ...
        <RelatedPeptides currentPeptide="Tirzepatide" />
