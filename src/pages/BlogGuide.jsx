      ...
      <div className="min-h-screen bg-white pt-32 pb-20">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-[32px] p-8 md:p-12 prose-headings:text-black prose-p:text-slate-600 prose-strong:text-black prose-a:text-[#8B2635] prose-code:text-[#8B2635] prose-pre:bg-slate-900 prose-table:border-slate-200 shadow-sm">
              {post.content.split('\n').map((line, idx) => {
                ...
                if (line.startsWith('- ')) return <li key={idx} className="ml-4 text-slate-600 marker:text-[#8B2635]">{line.substring(2)}</li>;
    ...
    <div className="min-h-screen bg-white pt-32 pb-20">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {blogPosts.map((post, idx) => (
            <motion.div
              ...
              className="bg-white border border-slate-200 hover:border-[#8B2635]/30 rounded-[32px] p-8 cursor-pointer transition-all hover:shadow-xl hover:shadow-red-900/5 group"
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="p-4 bg-[#8B2635] rounded-2xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                  <post.icon className="w-6 h-6 text-white" />
                </div>
                <div className="flex-1">
                  <h2 className="text-xl font-black text-black mb-2 leading-tight group-hover:text-[#8B2635] transition-colors">{post.title}</h2>
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center text-[#8B2635] font-bold text-sm uppercase tracking-wider group-hover:gap-2 transition-all">
        ...
        <motion.div
          ...
          className="mt-12 bg-[#8B2635] rounded-[32px] p-10 text-center relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <Link to={createPageUrl('Contact')}>
              <Button className="bg-white text-[#8B2635] hover:bg-red-50 font-bold px-8 py-6 rounded-full shadow-lg">
