    ...
    <div className="min-h-screen bg-white pt-32 pb-20">
      ...
      <div className="max-w-5xl mx-auto px-4">
        <Link to={createPageUrl('Home')}>
          <Button variant="outline" className="border-slate-200 text-slate-600 hover:text-black hover:bg-slate-50 mb-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
          <h1 className="text-5xl md:text-6xl font-black text-black mb-4 uppercase tracking-tight">What Researchers Say</h1>
        ...
        >
          <div className="max-w-lg mx-auto">
            ...
            <h2 className="text-2xl font-black text-black uppercase tracking-tight mb-3">Customer Reviews Coming Soon</h2>
        ...
        >
          <h2 className="text-2xl font-black text-black mb-6 uppercase tracking-tight">Why Researchers Choose Red Helix</h2>
