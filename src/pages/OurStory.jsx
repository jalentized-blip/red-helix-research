...
const Section = ({ icon: Icon, title, children, delay = 0 }) => (
  ...
  >
    <div className="flex items-start gap-4 mb-6">
      <div className="p-3 bg-[#8B2635]/10 rounded-xl flex-shrink-0 shadow-sm border border-red-100">
    ...
    <div className="min-h-screen bg-white pt-32 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Link to={createPageUrl('Home')}>
          <Button variant="outline" className="border-slate-200 text-slate-500 hover:text-[#8B2635] hover:border-[#8B2635] mb-8 bg-white shadow-sm">
            ← Back to Home
          </Button>
        </Link>
        ...
        >
          ...
          <p className="text-xl text-slate-600 leading-relaxed font-medium">
            Red Helix Research wasn't built to maximize profit margins. We were built to solve a problem in the gray market that has plagued researchers, athletes, and health-conscious individuals for years: <span className="text-[#8B2635] font-bold">lack of transparency, vendor accountability, and fair pricing.</span>
          </p>
        </motion.div>
        ...
        >
          ...
          <Link to={createPageUrl('Home')}>
            <Button className="bg-[#8B2635] hover:bg-[#6B1827] text-white px-8 py-6 text-lg font-black shadow-lg shadow-red-200">
              Shop With Us
            </Button>
          </Link>
        </motion.div>
