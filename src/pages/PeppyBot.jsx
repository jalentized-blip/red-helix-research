                        ...
                        {message.role === 'assistant' ? (
                          isProductsMessage ? (
                            <div className="space-y-3">
                              ...
                              <Link to={createPageUrl('Home') + '#all-products'} className="inline-block bg-red-700 hover:bg-red-600 text-amber-50 px-4 py-2 rounded-lg font-semibold transition-colors">
                                Shop Products
                              </Link>
                            </div>
                          ) : (
