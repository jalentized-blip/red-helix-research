  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-8">
      ...
      <div className="max-w-6xl mx-auto px-4">
        {/* Header */}
        <div className="mb-8">
          <Link to={createPageUrl('Home')} className="inline-flex items-center gap-2 text-slate-400 hover:text-[#8B2635] transition-colors mb-4 font-black uppercase tracking-widest text-[10px]">
            <ArrowLeft className="w-4 h-4" />
            Back to Home
          </Link>
          <h1 className="text-5xl md:text-7xl font-black text-black mb-4 tracking-tighter uppercase leading-none">Community <span className="text-[#8B2635]">COA Reports</span></h1>
        ...
        <div className="mb-8 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <div className="flex gap-3">
            {isAdmin && selectedIds.size > 0 && (
              <>
                ...
                <Button
                  ...
                  disabled={isDeleting}
                  className="bg-[#8B2635] hover:bg-red-700 text-white rounded-2xl font-black uppercase tracking-widest text-[10px] px-6"
                >
            ...
            <Button
              ...
              className="bg-black hover:bg-[#8B2635] text-white rounded-2xl font-black uppercase tracking-widest text-[10px] px-6 shadow-lg shadow-slate-900/10"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredCOAs.map((coa, index) => (
              <motion.div
                ...
                id={`coa-${coa.id}`}
                className={`bg-slate-50 border rounded-[32px] p-8 transition-all hover:shadow-xl hover:shadow-[#8B2635]/5 ${
                  selectedIds.has(coa.id)
                    ? 'border-[#8B2635] bg-red-50/30'
                    : highlightedId === coa.id
                    ? 'border-[#8B2635] ring-4 ring-[#8B2635]/20 shadow-xl shadow-[#8B2635]/10'
                    : 'border-slate-100 hover:border-[#8B2635]/30'
                }`}
              >
                {isAdmin && (
                  <div className="space-y-3 mb-6 pb-6 border-b border-slate-100">
                    ...
                    <div className="flex items-center gap-3">
                      <Checkbox
                        ...
                        className="border-slate-300 data-[state=checked]:bg-[#8B2635] data-[state=checked]:border-[#8B2635]"
                      />
                      ...
                      <div className="flex items-center gap-2 bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-3">
                        ...
                        <div className="flex gap-2 ml-auto">
                          ...
                          <button
                            ...
                            className="p-2 rounded-lg bg-[#8B2635] text-white hover:bg-red-700 transition-colors shadow-sm shadow-[#8B2635]/20"
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-[10px] font-black text-[#8B2635] uppercase tracking-[0.2em] mb-1">Research Compound</p>
                  ...
                  <div className="flex gap-3 pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex items-center justify-center gap-2 bg-white border border-slate-200 text-black hover:border-[#8B2635] hover:text-[#8B2635] transition-all rounded-2xl font-black uppercase tracking-widest text-[10px] py-4 shadow-sm"
                    >
                      Full Analysis
                    ...
                    {coa.coa_link && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 flex items-center justify-center gap-2 bg-[#8B2635] text-white hover:bg-red-700 transition-all rounded-2xl font-black uppercase tracking-widest text-[10px] py-4 shadow-lg shadow-[#8B2635]/20"
                      >
                        Verification
                        <ExternalLink className="w-4 h-4" />
                      </a>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 border transition-all rounded-2xl font-black uppercase tracking-widest text-[10px] py-3 ${
                      copiedId === coa.id
                        ...
                        : 'bg-white border-slate-200 text-slate-500 hover:border-[#8B2635] hover:text-[#8B2635]'
                    }`}
                  >
        ...
        <div className="mt-16 text-center">
          <Button
            onClick={() => setShowUploadModal(true)}
            className="bg-[#8B2635] hover:bg-[#6B1827] text-white gap-3 rounded-[32px] font-black uppercase tracking-widest text-xs px-12 py-8 shadow-xl shadow-[#8B2635]/20"
          >
